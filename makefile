...
# Compile .cpp to .o
%.o: %.cpp
	$(CXX) $(CXXFLAGS) $(OPENCV_CFLAGS) -I$(INCLUDE_DIR) -c $< -o $@

# Clean build
clean:
	rm -f $(SRC_DIR)/*.o $(LIB_DIR)/*.o *.o image_data.o main.o $(TARGET)
	rm -f $(SRC_DIR)/*.o $(LIB_DIR)/*.o *.o create_input_array.o $(TARGET_INPUT_CREATE)
	rm -f $(SRC_CUDA_DIR)/*.o $(LIB_DIR)/*.o *.o create_input_array.o $(TARGET_GPU)
